 ...
 */
package de.hybris.stttraining.fulfilmentprocess.test.jobs;
...
import de.hybris.stttraining.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = StttrainingFulfilmentProcessConstants.ORDER_PROCESS_NAME;
