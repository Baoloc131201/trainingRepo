 ...
 */
package de.hybris.stttraining.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(StttrainingFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(StttrainingFulfilmentProcessConstants.PARENT_PROCESS);
