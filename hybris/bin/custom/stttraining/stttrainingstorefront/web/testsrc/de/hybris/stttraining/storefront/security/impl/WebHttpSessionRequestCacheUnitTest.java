...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/stttrainingstorefront/electronics/en",
						"https://electronics.local:9002/stttrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/stttrainingstorefront/electronics/en",
						"https://electronics.local:9002/stttrainingstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/stttrainingstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/stttrainingstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/stttrainingstorefront/electronics/en",
						"https://electronics.local:9002/stttrainingstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/stttrainingstorefront",
						"https://electronics.local:9002/stttrainingstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/stttrainingstorefront",
						"https://electronics.local:9002/stttrainingstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/stttrainingstorefront/electronics/en",
						"https://electronics.local:9002/stttrainingstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
