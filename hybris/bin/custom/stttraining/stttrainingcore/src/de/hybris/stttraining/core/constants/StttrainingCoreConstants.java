 ...
 */
package de.hybris.stttraining.core.constants;

/**
 * Global class for all StttrainingCore constants. You can add global constants for your extension into this class.
 */
public final class StttrainingCoreConstants extends GeneratedStttrainingCoreConstants
{
	public static final String EXTENSIONNAME = "stttrainingcore";


	private StttrainingCoreConstants()
	{
		//empty
	}
	...
	public static final String CATALOG_VERSION_POWERTOOLS_PRODUCT_CATALOG_ID = "powertoolsProductCatalog";
	public static final String CATALOG_VERSION_STAGED_NAME = "Staged";
