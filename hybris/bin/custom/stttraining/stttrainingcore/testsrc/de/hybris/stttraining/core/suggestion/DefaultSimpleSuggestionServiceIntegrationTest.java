 ...
 */
package de.hybris.stttraining.core.suggestion;
...
import de.hybris.stttraining.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/stttrainingcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
