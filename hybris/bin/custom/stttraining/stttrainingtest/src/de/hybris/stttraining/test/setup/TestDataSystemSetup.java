 ...
 */
package de.hybris.stttraining.test.setup;
...
import de.hybris.stttraining.test.constants.StttrainingTestConstants;
import de.hybris.stttraining.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = StttrainingTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/stttrainingtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/stttrainingtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/stttrainingtest/import/cstickets.impex");
			...
			importImpexFile(context, "/stttrainingtest/import/csquotes.impex");
		}
	}
}
